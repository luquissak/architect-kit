...
# Para SVG, o DPI não afeta a nitidez (pois é vetorial), mas mantemos por consistência
graph_attr["dpi"] = "600"

with Diagram("Plataforma MLOps SIPML - Referência Gartner v3", show=False, direction="LR", graph_attr=graph_attr, outformat="svg"):
